...
const TablaUnidad = () => {
  ...
  const columns = [
    { name: "Faena", selector: (row) => row.flotas.lugarTrabajo?.nombre, sortable: true, width: "100px" },
    { name: "Flota", selector: (row) => row.flotas.flotas?.nombre, sortable: true, width: "100px" },
