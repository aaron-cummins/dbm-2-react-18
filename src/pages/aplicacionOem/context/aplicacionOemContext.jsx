...
export const AplicacionOemContextProvider = props => {
    ...
    const registrarAplicacionOem = async aplicacionoem => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar crear el aplicacion oem. ${error}`);
        }
    ...
    const actualizarAplicacionOem = async aplicacionoem => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar actualizar el aplicacionoem. ${error}`);
        }
    }
    ...
    const eliminarAplicacionOem = async id => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar eliminar el aplicacionoem. ${error}`);
        }
