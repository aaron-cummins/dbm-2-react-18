...
export const TipoCombustibleContextProvider = props => {
    ...
    const registrarTipoCombustible = async tipocombustible => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar crear el tipo combustible. ${error}`);
        }
    ...
    const actualizarTipoCombustible = async tipocombustible => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar actualizar el tipo combustible. ${error}`);
        }
    }
    ...
    const eliminarTipoCombustible = async id => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar eliminar el tipo combustible. ${error}`);
        }
