...
export const CargoContextProvider = props => {
    ...
    const registrarCargo = async cargo => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar crear el cargo. ${error}`);
        }
    ...
    const actualizarCargo = async cargo => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar actualizar el cargo. ${error}`);
        }
    }
    ...
    const eliminarCargo = async id => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar eliminar el cargo. ${error}`);
        }
