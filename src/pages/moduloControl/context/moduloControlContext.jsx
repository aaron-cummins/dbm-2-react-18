...
export const ModuloControlContextProvider = props => {
    ...
    const registrarModuloControl = async modulocontrol => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar crear el Módulo control. ${error}`);
        }
    ...
    const actualizarModuloControl = async modulocontrol => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar actualizar el Módulo control. ${error}`);
        }
    }
    ...
    const eliminarModuloControl = async id => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar eliminar el Módulo control. ${error}`);
        }
