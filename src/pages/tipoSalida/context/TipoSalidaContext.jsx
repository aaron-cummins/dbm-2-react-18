...
export const TipoSalidaContextProvider = (props) => {
  ...
  const registrarTipoSalida = async (TipoSalida) => {
    try {
      ...
      alerta(
        "danger",
        `'Ocurrió un error al intentar crear el Tipo Salida. ${error}`
      );
    }
  };
  ...
  const actualizarTipoSalida = async (TipoSalida) => {
    try {
      ...
      alerta(
        "danger",
        `'Ocurrió un error al intentar actualizar el Tipo Salida. ${error}`
      );
    }
  };
  ...
  const eliminarTipoSalida = async (id) => {
    try {
      ...
      alerta(
        "danger",
        `'Ocurrió un error al intentar eliminar el Tipo Salida. ${error}`
      );
    }
  };
