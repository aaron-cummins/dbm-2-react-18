...
export const TipoContratoContextProvider = (props) => {
  ...
  const registrarTipoContrato = async (TipoContrato) => {
    try {
      ...
      alerta(
        "danger",
        `'Ocurrió un error al intentar crear el Tipo Contrato. ${error}`
      );
    }
  };
  ...
  const actualizarTipoContrato = async (TipoContrato) => {
    try {
      ...
      alerta(
        "danger",
        `'Ocurrió un error al intentar actualizar el Tipo Contrato. ${error}`
      );
    }
  };
  ...
  const eliminarTipoContrato = async (id) => {
    try {
      ...
      alerta(
        "danger",
        `'Ocurrió un error al intentar eliminar el Tipo Contrato. ${error}`
      );
    }
  };
