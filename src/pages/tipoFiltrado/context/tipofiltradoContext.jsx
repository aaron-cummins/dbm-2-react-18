...
export const TipoFiltradoContextProvider = props => {
    ...
    const registrarTipoFiltrado = async tipofiltrado => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar crear el tipo filtrado. ${error}`);
        }
    ...
    const actualizarTipoFiltrado = async tipofiltrado => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar actualizar el tipo filtrado. ${error}`);
        }
    }
    ...
    const eliminarTipoFiltrado = async id => {
        try {
            ...
            console.log(error);
            alerta('danger', `'Ocurrió un error al intentar eliminar el tipo filtrado. ${error}`);
        }
