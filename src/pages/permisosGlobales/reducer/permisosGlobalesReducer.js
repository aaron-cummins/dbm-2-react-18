...
export default (state, action) => {
    ...
    switch (action.type) {
        ...
        case REGISTRAR:
            return {
                ...state,
                permisoGlobalList: [...state.permisoGlobalList, action.payload]
            };
        case OBTENER:
            return {
                ...state,
        ...
        case ACTUALIZAR:
            return {
                ...state,
                permisoGlobalList: state.permisoGlobalList.map(
                    permisoGlobal => permisoGlobal.id === action.payload.id ? action.payload : permisoGlobal
                )
            };
        case ELIMINAR:
            return {
